...
if test x"`uname`" = xDarwin ; then
  ...
  # xcodebuild -project build-mac/mailcore2.xcodeproj -sdk $SIMULATORSDK -scheme "static mailcore2 ios" build ARCHS="arm64" >/dev/null
  ...
  # xcodebuild -project build-mac/mailcore2.xcodeproj -sdk $SIMULATORSDK -scheme "test-ios" build ARCHS="arm64"
